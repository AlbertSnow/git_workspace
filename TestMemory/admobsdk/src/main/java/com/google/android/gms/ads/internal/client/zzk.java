...
public final class zzk
{
  ...
  private static AdSize[] zzz(String paramString)
  {
    ...
    for (int i = 0; i < arrayOfString1.length; i++)
    {
      ...
      {
        String[] arrayOfString2 = str.split("[xX]");
        ...
        try
        {
          j = "FULL_WIDTH".equals(arrayOfString2[0]) ? -1 : Integer.parseInt(arrayOfString2[0]);
          k = "AUTO_HEIGHT".equals(arrayOfString2[1]) ? -2 : Integer.parseInt(arrayOfString2[1]);
        }
  ...
  public zzk(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    int i = !TextUtils.isEmpty(str1) ? 1 : 0;
    int j = !TextUtils.isEmpty(str2) ? 1 : 0;
    if ((i != 0) && (j == 0))
    {
      this.zzuo = zzz(str1);
    }
    ...
    this.zzpS = localTypedArray.getString(R.styleable.AdsAttrs_adUnitId);
