...
class FeedbackCategorySpinner$CategoryAlertDialog$3
  implements ExpandableListView.OnGroupClickListener
{
  public boolean onGroupClick(ExpandableListView paramExpandableListView, View paramView, int paramInt, long paramLong)
  {
    ...
    else
    {
      ...
      for (int i = 0; i < FeedbackCategorySpinner.CategoryAlertDialog.access$300(this.this$1).getCount(); i++)
        FeedbackCategorySpinner.CategoryAlertDialog.access$300(this.this$1).collapseGroup(i);
 ...
 * Qualified Name:     com.wandoujia.p4.pay.feedback.FeedbackCategorySpinner.CategoryAlertDialog.3
