...
class PayFragment$10$2
  implements ResultFragment.OnFinishListener
{
  public void onFinish()
  {
    CallbackWrapper.invoke(this.val$activity, -1, CallbackWrapper.Type.PAY, CallbackWrapper.Status.FAIL, "Balance Pay success!", PayFragment.access$1700(this.this$1.this$0).toJSONString());
  }
}

/* Location:           C:\WorkSpace\WandDouJiaNotificationBar\WanDou1.jar
 * Qualified Name:     com.wandoujia.p4.pay.fragment.PayFragment.10.2
