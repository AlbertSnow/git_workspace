package com.wandoujia.p4.http.a;
  ...
  implements DataApi
{
  ...
  public final <T, M extends GZipHttpDelegate<?, T>,  extends Cacheable<T>> DataClientCache.CacheResult<T> a(M paramM)
  {
    return a().executeByCache(paramM);
  }

  public final <T, M extends GZipHttpDelegate<?, T>,  extends Cacheable<T>> T b(M paramM)
  {
    return a().executeByNetwork(paramM);
  }
 ...
 * Qualified Name:     com.wandoujia.p4.http.a.a
