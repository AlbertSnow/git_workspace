...
public final class f extends i<CommunityTopicModel>
{
  ...
  protected final n<CommunityTopicModel> c(int paramInt1, int paramInt2)
  {
    ...
    {
      ag localag = new ag();
      ((v)localag.getRequestBuilder()).a(str).b("replied").a(paramInt1).b(paramInt2).setAttachDefaultCookie(true);
 ...
 * Qualified Name:     com.wandoujia.p4.community.http.b.f
