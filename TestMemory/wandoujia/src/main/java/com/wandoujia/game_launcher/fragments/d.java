...
{
  d(GLHomeFragment paramGLHomeFragment)
  {
  }
  ...
  public final void onClick(View paramView)
  {
    ...
    localIntent.setData(Uri.parse("wdj://games/explore"));
    if (IntentUtils.canHandleIntent(paramView.getContext(), localIntent))
    {
      this.a.startActivity(localIntent);
      b.a(paramView, "game_launcher", ViewLogPackage.Element.BUTTON, ViewLogPackage.Action.REDIRECT, this.a.getString(R.string.title_find_game));
      return;
    }
 ...
 * Qualified Name:     com.wandoujia.game_launcher.fragments.d
