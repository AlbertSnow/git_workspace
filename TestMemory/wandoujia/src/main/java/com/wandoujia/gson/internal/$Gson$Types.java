...
public final class $Gson$Types
{
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            while (j == 0);
            return new .Gson.Types.ParameterizedTypeImpl(localType4, ((ParameterizedType)localObject).getRawType(), arrayOfType3);
          }
        ...
        return new .Gson.Types.WildcardTypeImpl(new Type[] { Object.class }, new Type[] { localType2 });
      }
      while (arrayOfType2.length != 1);
      localType1 = a(paramType1, paramClass, arrayOfType2[0]);
    }
    while (localType1 == arrayOfType2[0]);
    return (Type)new .Gson.Types.WildcardTypeImpl(new Type[] { localType1 }, a);
  }
  ...
  public static Class<?> b(Type paramType)
  {
    for (Type localType1 = paramType; ; localType1 = ((WildcardType)localType1).getUpperBounds()[0])
    {
      ...
      if ((localType1 instanceof ParameterizedType))
      {
        ...
        b.a(localType2 instanceof Class);
  ...
  {
    b.a(paramClass2.isAssignableFrom(paramClass1));
 ...
 * Qualified Name:     com.wandoujia.gson.internal..Gson.Types
