...
public class CardShowListView extends ListView
{
  ...
  private j c = new f(this);

  public CardShowListView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  public CardShowListView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.wandoujia.logv3.toolkit.cardshow.CardShowListView
