...
public final class BaseBytes extends Message
{
  ...
  private BaseBytes(BaseBytes.Builder paramBuilder)
  {
    super(paramBuilder);
  ...
  public final boolean equals(Object paramObject)
  {
    if (paramObject == this)
      return true;
    if (!(paramObject instanceof BaseBytes))
      return false;
    return equals(this.val, ((BaseBytes)paramObject).val);
  }
 ...
 * Qualified Name:     com.wandoujia.base.models.BaseBytes
