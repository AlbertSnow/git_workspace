...
public final class BaseInts extends Message
{
  ...
  private BaseInts(BaseInts.Builder paramBuilder)
  {
    super(paramBuilder);
  ...
  public final boolean equals(Object paramObject)
  {
    if (paramObject == this)
      return true;
    if (!(paramObject instanceof BaseInts))
      return false;
    return equals(this.val, ((BaseInts)paramObject).val);
  }
 ...
 * Qualified Name:     com.wandoujia.base.models.BaseInts
