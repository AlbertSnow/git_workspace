...
public class MimeTypeMap
{
  ...
  public static MimeTypeMap getSingleton()
  {
    if (sMimeTypeMap == null)
    {
      ...
      sMimeTypeMap = localMimeTypeMap;
      localMimeTypeMap.loadEntry("application/andrew-inset", "ez");
      ...
      sMimeTypeMap.loadEntry("text/javascript", "js");
    }
    return sMimeTypeMap;
  }
 ...
 * Qualified Name:     com.wandoujia.base.utils.MimeTypeMap
