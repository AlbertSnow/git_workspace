...
public final class BaseStrs extends Message
{
  ...
  private BaseStrs(BaseStrs.Builder paramBuilder)
  {
    super(paramBuilder);
  ...
  public final boolean equals(Object paramObject)
  {
    if (paramObject == this)
      return true;
    if (!(paramObject instanceof BaseStrs))
      return false;
    return equals(this.val, ((BaseStrs)paramObject).val);
  }
 ...
 * Qualified Name:     com.wandoujia.base.models.BaseStrs
