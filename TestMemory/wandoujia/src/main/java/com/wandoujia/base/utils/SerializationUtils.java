...
public class SerializationUtils
{
  ...
  public static <T extends Serializable> T clone(T paramT)
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: invokestatic 20	com/wandoujia/base/utils/SerializationUtils:serialize	(Ljava/io/Serializable;)[B
    //   14: invokespecial 23	java/io/ByteArrayInputStream:<init>	([B)V
    //   17: astore_1
    //   18: new 25	com/wandoujia/base/utils/f
    //   21: dup
    //   22: aload_1
    //   23: aload_0
    ...
    //   30: invokespecial 38	com/wandoujia/base/utils/f:<init>	(Ljava/io/InputStream;Ljava/lang/ClassLoader;)V
    //   33: astore_2
    //   34: aload_2
    //   35: invokevirtual 42	com/wandoujia/base/utils/f:readObject	()Ljava/lang/Object;
    //   38: checkcast 44	java/io/Serializable
    //   41: astore 7
    //   43: aload_2
    //   44: invokevirtual 47	com/wandoujia/base/utils/f:close	()V
    //   47: aload 7
    //   49: areturn
    //   50: astore 8
    //   52: new 49	com/wandoujia/base/utils/SerializationException
    //   55: dup
    //   56: ldc 51
    //   58: aload 8
    //   60: invokespecial 54	com/wandoujia/base/utils/SerializationException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   63: athrow
    //   64: astore 11
    //   66: aconst_null
    //   67: astore_2
    //   68: aload 11
    //   70: astore_3
    //   71: new 49	com/wandoujia/base/utils/SerializationException
    //   74: dup
    //   75: ldc 56
    //   77: aload_3
    //   78: invokespecial 54	com/wandoujia/base/utils/SerializationException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   81: athrow
    //   82: astore 4
    //   84: aload_2
    //   85: ifnull +7 -> 92
    //   88: aload_2
    //   89: invokevirtual 47	com/wandoujia/base/utils/f:close	()V
    //   92: aload 4
    //   94: athrow
    //   95: astore 10
    //   97: aconst_null
    ...
    //   99: aload 10
    //   101: astore 6
    //   103: new 49	com/wandoujia/base/utils/SerializationException
    //   106: dup
    //   107: ldc 58
    //   109: aload 6
    //   111: invokespecial 54	com/wandoujia/base/utils/SerializationException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   114: athrow
    //   115: astore 5
    //   117: new 49	com/wandoujia/base/utils/SerializationException
    //   120: dup
    //   121: ldc 51
    //   123: aload 5
    //   125: invokespecial 54	com/wandoujia/base/utils/SerializationException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   128: athrow
    //   129: astore 9
    //   131: aload 9
    //   133: astore 4
  ...
  public static Object deserialize(java.io.InputStream paramInputStream)
  {
    ...
    //   39: aconst_null
    //   40: astore_2
    //   41: new 49	com/wandoujia/base/utils/SerializationException
    //   44: dup
    //   45: aload_3
    //   46: invokespecial 77	com/wandoujia/base/utils/SerializationException:<init>	(Ljava/lang/Throwable;)V
    //   49: athrow
    //   50: astore 4
    //   52: aload_2
    //   53: astore_1
    ...
    //   64: athrow
    //   65: astore 6
    //   67: new 49	com/wandoujia/base/utils/SerializationException
    //   70: dup
    //   71: aload 6
    //   73: invokespecial 77	com/wandoujia/base/utils/SerializationException:<init>	(Ljava/lang/Throwable;)V
    //   76: athrow
    //   77: astore 4
    //   79: goto -25 -> 54
    //   82: astore 8
  ...
  public static void serialize(Serializable paramSerializable, java.io.OutputStream paramOutputStream)
  {
    ...
    //   34: aconst_null
    //   35: astore_2
    //   36: new 49	com/wandoujia/base/utils/SerializationException
    //   39: dup
    //   40: aload_3
    //   41: invokespecial 77	com/wandoujia/base/utils/SerializationException:<init>	(Ljava/lang/Throwable;)V
    //   44: athrow
    //   45: astore 4
    //   47: aload_2
    //   48: ifnull +7 -> 55
 ...
 * Qualified Name:     com.wandoujia.base.utils.SerializationUtils
