...
{
  private final GestureDetector.OnGestureListener a = new f(this);
  private final AbsListView.OnScrollListener b = new g(this);
  private float c;
  private float d;
  private float e;
  private float f;
  ...
  {
    paramContentScrollView.setOnScrollChangeListener(new h(this, paramContentScrollView));
  }
  ...
  public void setOnScrollChangedListener$130f2e40(q paramq)
  {
    this.q = paramq;
  }
}
 ...
 * Qualified Name:     com.wandoujia.phoenix2.av.view.ScrollDownLayout
