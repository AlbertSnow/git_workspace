...
public class FlowLayout extends ViewGroup
{
  ...
  private void a(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    try
    {
      this.a = localTypedArray.getDimensionPixelSize(R.styleable.FlowLayout_horizontalSpacing, 0);
      this.b = localTypedArray.getDimensionPixelSize(R.styleable.FlowLayout_verticalSpacing, 0);
      this.c = localTypedArray.getInteger(R.styleable.FlowLayout_flowLayoutOrientation, 0);
      this.d = localTypedArray.getInteger(R.styleable.FlowLayout_maxLines, 0);
      this.e = localTypedArray.getBoolean(R.styleable.FlowLayout_debugDraw, false);
      return;
    }
    finally
    {
 ...
 * Qualified Name:     com.wandoujia.accessibility.hibernation.view.FlowLayout
