  ...
  implements android.support.v7.internal.view.menu.k, z
{
  ...
  public static ActionMenuView.LayoutParams b()
  {
    ActionMenuView.LayoutParams localLayoutParams = j();
  ...
  private static ActionMenuView.LayoutParams j()
  {
  ...
  public final void a(y paramy, android.support.v7.internal.view.menu.j paramj)
  {
    this.g = paramy;
    this.h = paramj;
  }
  ...
  public final android.support.v7.internal.view.menu.i c()
  {
    return this.a;
  }
  ...
  public Menu getMenu()
  {
    ...
    label109: for (Object localObject = this.g; ; localObject = new j(0))
    {
    ...
    while (true)
    {
      ...
      if ((this.i) && (i1 > 0))
      {
        ...
        if (i19 < i18)
        {
          ...
          if ((!bool3) || (!((ActionMenuItemView)localView4).b()))
            break;
          bool4 = true;
        ...
        label651: if (localLayoutParams5.b == i30)
        {
          ...
          while (true)
          {
            ...
            while (true)
            {
              int i27;
              int i28;
              label1035: ActionMenuView.LayoutParams localLayoutParams3;
              int i29;
              if (f2 > 0.0F)
              {
                i27 = (int)(i22 * i12 / f2);
  ...
  public void setOnMenuItemClickListener(l paraml)
  {
    this.m = paraml;
  }
