  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  bn mEnterTransitionCallback = null;
  Object mExitTransition = null;
  bn mExitTransitionCallback = null;
  int mFragmentId;
  s mFragmentManager;
  boolean mFromLayout;
  boolean mHasMenu;
  ...
  Fragment findFragmentByWho(String paramString)
  {
    ...
    if (this.mChildFragmentManager != null)
    {
      s locals = this.mChildFragmentManager;
      if ((locals.a != null) && (paramString != null))
        for (int i = -1 + locals.a.size(); ; i--)
        {
          if (i < 0)
            break label85;
          Fragment localFragment = (Fragment)locals.a.get(i);
  ...
  public LayoutInflater getLayoutInflater(Bundle paramBundle)
  {
    ...
    u.a(localLayoutInflater, this.mChildFragmentManager);
    return localLayoutInflater;
  }

  public ak getLoaderManager()
  {
    if (this.mLoaderManager != null)
  ...
  void performSaveInstanceState(Bundle paramBundle)
  {
    ...
    if (this.mChildFragmentManager != null)
    {
      Parcelable localParcelable = this.mChildFragmentManager.j();
      if (localParcelable != null)
  ...
  {
    this.mEnterTransitionCallback = parambn;
  }
  ...
  {
    this.mExitTransitionCallback = parambn;
  }
