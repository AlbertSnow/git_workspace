...
final class av extends bl
{
  private av(SlidingPaneLayout paramSlidingPaneLayout)
  {
  }
  ...
  public final void a(int paramInt)
  {
    if (SlidingPaneLayout.b(this.a).a() == 0)
    {
      if (SlidingPaneLayout.c(this.a) == 0.0F)
      {
        ...
        localSlidingPaneLayout2.sendAccessibilityEvent(32);
    ...
    SlidingPaneLayout.d(this.a);
    localSlidingPaneLayout1.sendAccessibilityEvent(32);
