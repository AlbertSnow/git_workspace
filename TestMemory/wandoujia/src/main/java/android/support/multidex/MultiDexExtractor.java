...
final class MultiDexExtractor
{
  ...
  private static void extract(ZipFile paramZipFile, ZipEntry paramZipEntry, File paramFile, String paramString)
  {
    ...
    //   214: astore 10
    //   216: aload 4
    //   218: invokestatic 184	android/support/multidex/MultiDexExtractor:closeQuietly	(Ljava/io/Closeable;)V
    //   221: aload 5
    ...
    //   239: athrow
    //   240: aload 4
    //   242: invokestatic 184	android/support/multidex/MultiDexExtractor:closeQuietly	(Ljava/io/Closeable;)V
    //   245: aload 5
  ...
  private static void prepareDexDir(File paramFile, String paramString)
  {
    ...
    while (true)
    {
      ...
      break label89;
      break;
      label168: new StringBuilder("Deleted old file ").append(localFile.getPath());
    }
  }
